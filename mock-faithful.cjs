...
doc.rect(qrBoxX + 5, qrBoxY + 5, qrBoxSize - 10, qrBoxSize - 10, 'S');
doc.setFontSize(8);
doc.setTextColor(150, 150, 150);
doc.text('QR CODE', qrBoxX + 22, qrBoxY + 45);
...
doc.setFont('helvetica', 'normal');
doc.text('05 August 2025', darkBlockX + 20, currentLeftY + 14);

currentLeftY += 40;
doc.setFont('helvetica', 'bold');
doc.text('Validade :', darkBlockX + 20, currentLeftY);
doc.setFont('helvetica', 'normal');
doc.text('25 August 2025', darkBlockX + 20, currentLeftY + 14);
...
doc.setFont('helvetica', 'normal');
doc.text('Seraphina Blue', darkBlockX + 20, currentLeftY + 14);
doc.setFontSize(8);
doc.setTextColor(200, 200, 200);
doc.text('(555) 123-4567-9876', darkBlockX + 20, currentLeftY + 30);
doc.text('seraphinablue@mail.com', darkBlockX + 20, currentLeftY + 42, { maxWidth: darkBlockW - 40 });
...
// Logo / Tagline
drawAppLogo(doc, rightContentX, rightContentY);
...
doc.setFontSize(9);
doc.setTextColor(42, 42, 42);
doc.text('(11) 99999-9999', rightContentX + 20, rightContentY + 34);
doc.text('Reforma Fachada', rightContentX + 130, rightContentY + 34);
...
doc.setTextColor(42, 42, 42);
doc.text('Lucas Engenharia', rightContentX + 150, rightContentY - 10);
doc.text('Engenheiro Civil', rightContentX + 150, rightContentY + 12);
doc.text('123456-7', rightContentX + 150, rightContentY + 24);

// 4. Table Area
let tableY = darkBlockY + darkBlockH + 30;
const itemsBody = [
  ['Logo Design', '', 'Hour', ''],
  ['Visual Identity Design', '', 'Hour', ''],
  ['Brochure Design', '', 'Hour', ''],
  ['Social Media Design', '', 'Hour', ''],
  ['Merchandise Design', '', 'Hour', ''],
];
...
doc.text('.200', pageWidth - margin - 20, currentY + 30, { align: 'right' });

doc.text('Descontos', margin + 20, currentY + 50);
doc.text(':', margin + 100, currentY + 50);
doc.text('', pageWidth - margin - 20, currentY + 50, { align: 'right' });

doc.setFontSize(11);
doc.text('Total', margin + 20, currentY + 70);
doc.text(':', margin + 100, currentY + 70);
doc.text('.320', pageWidth - margin - 20, currentY + 70, { align: 'right' });
...
doc.setFont('helvetica', 'normal');
doc.setTextColor(150, 150, 150);
doc.text('contato@empresa.com', footerRightX, footerY + 12);

doc.setFillColor(42, 42, 42);
doc.rect(footerRightX - 25, footerY + 20, 16, 16, 'F');
doc.setTextColor(255, 255, 255);
doc.text('O', footerRightX - 21, footerY + 31);
doc.setTextColor(42, 42, 42);
doc.setFont('helvetica', 'bold');
doc.text('Telefone', footerRightX, footerY + 25);
doc.setFont('helvetica', 'normal');
doc.setTextColor(150, 150, 150);
doc.text('(11) 9999-9999', footerRightX, footerY + 37);

doc.save('quote_preview_faithful.pdf');
