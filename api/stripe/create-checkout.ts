...
const STRIPE_PRICES: Record<string, Record<string, string>> = {
  monthly: { 
    starter: process.env.STRIPE_PRICE_STARTER_MONTHLY || 'price_1U5y52Ht1GuKvdoeS6nyP9KJ', 
    pro: process.env.STRIPE_PRICE_PRO_MONTHLY || 'price_1U5y5VHt1GuKvdoeG7DX2UrR', 
    business: process.env.STRIPE_PRICE_BUSINESS_MONTHLY || 'price_1U5y5wHt1GuKvdoefGFVgWho' 
  },
  annual: { 
    starter: process.env.STRIPE_PRICE_STARTER_ANNUAL || 'price_1U5yKNHt1GuKvdoelS5v4j5E', 
    pro: process.env.STRIPE_PRICE_PRO_ANNUAL || 'price_1U5yL4Ht1GuKvdoezJcnlgtc', 
    business: process.env.STRIPE_PRICE_BUSINESS_ANNUAL || 'price_1U5yMwHt1GuKvdoemZrVbRne' 
  }
};
