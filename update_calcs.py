...
# Replace the categories view rendering
              ...
              return (
                ...
                >
                  ...
                  <div style={{ position: 'relative', zIndex: 1 }}>
                    <h3 style={{ fontSize: '15px', fontWeight: 700, color: 'var(--color-text)' }}>{title}</h3>
                    <p style={{ fontSize: '12px', color: 'var(--color-text-muted)', marginTop: 2 }}>{cat.count} ferramentas</p>
                  </div>
                </div>
              );
            })}
