  ...
  return (
    <div className='app-container' data-theme={theme} style={{ minHeight: '100vh', backgroundColor: 'var(--bg-main)', display: 'flex', flexDirection: 'column' }}>
      <Helmet>
        ...
        <meta name='description' content={\\\Use nossa \ sem precisar de cadastro. Calcule a quantidade exata de material para evitar desperdício.\\\} />
      </Helmet>
...
fs.writeFileSync('src/components/public/PublicCalculatorView.tsx', content, 'utf8');
