...
let code = fs.readFileSync('src/components/onboarding/OnboardingEngine_old.tsx', 'utf8');
...
code = code.replace(/window\.location\.reload\(\);/g, "setForceOnboarding(false);");
...
console.log("Restored and improved OnboardingEngine");
